...
export default function ModComponent({mod, toggleFunction}: {mod: Mod, toggleFunction: Function}) {
    ...
    return (
        <div className="w-full h-24 bg-white text-black rounded-3xl p-3 px-3 md:px-8 grid grid-cols-6 grid-rows-1">
            <div className="col-span-4 md:col-span-5 w-full flex flex-row space-x-3 justify-start items-center">
                ...
                <p onClick={() => copyText(hash)} className="underline cursor-pointer truncate" title="Click me to copy!">{ hash ? hash : "Calculating..."}</p>
            </div>
